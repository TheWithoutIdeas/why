...
client.on("message", async message => {
  ...
  if(message.author.id === "861376659597164545") {
    ...
    if(datecheck = 21) {
      ...
      .setDescription(`As you are the owner, you got your 125 cash delivery!`)
      .setColor("PURPLE")
  ...
  if(vipget === true) {
    ...
    if(datecheck = 21) {
      ...
      let embed = new Discord.MessageEmbed()
      .setTitle(`You got your cash delivered!`)
      .setDescription(`As you are vip, you got your 25 cash delivery!`)
      .setColor("PURPLE")
      .setThumbnail(`https://discord.com/assets/11b9d8164d204c7fd48a88a515745c1d.svg`)
      message.author.send(embed)
      }
  ...
  if(vipgoldget === true) {
    ...
    if(datecheck = 21) {
      ...
      let embed = new Discord.MessageEmbed()
      .setTitle(`You got your cash delivered!`)
      .setDescription(`As you are vip gold, you got your 45 cash delivery!`)
      .setColor("PURPLE")
      .setThumbnail(`https://discord.com/assets/11b9d8164d204c7fd48a88a515745c1d.svg`)
      message.author.send(embed)
      }
  ...
  if(vipdiamondget === true) {
    ...
    if(datecheck = 21) {
      ...
      let embed = new Discord.MessageEmbed()
      .setTitle(`You got your cash delivered!`)
      .setDescription(`As you are vip diamond, you got your 65 cash delivery!`)
      .setColor("PURPLE")
      .setThumbnail(`https://discord.com/assets/11b9d8164d204c7fd48a88a515745c1d.svg`)
      message.author.send(embed)
      }
  ...
  if(developerget === true) {
    ...
    if(datecheck = 21) {
      ...
      let embed = new Discord.MessageEmbed()
      .setTitle(`You got your cash delivered!`)
      .setDescription(`As you are a developer, you got your 100 cash delivery!`)
      .setColor("PURPLE")
      .setThumbnail(`https://discord.com/assets/11b9d8164d204c7fd48a88a515745c1d.svg`)
      message.author.send(embed)
      }
